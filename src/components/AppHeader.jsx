...
export default function AppHeader() {
  return (
    <header className="sticky top-0 z-30 border-b border-white/10 bg-brand-900/85 backdrop-blur-lg">
      <div className="mx-auto flex max-w-[1200px] items-center gap-3 px-4 py-3 sm:px-6 lg:py-5">
        ...
        <div className="flex items-center gap-2.5 lg:hidden">
          ...
          <div className="min-w-0">
            <p className="font-display text-sm leading-tight font-semibold text-white">
              LibSpace
            </p>
